...
> [!NOTE]
> Признаюсь честно - вторую часть домашнего задания выполнить не смог, хоть и провозился два вечера. Планирую позде вернуться к этому задаиню.   
...
### ✅ Результат:   
- [x] Результат задания 1 - Все 3 способа для nginx реализованы. Результат см. на скриншоте 🖼️ ["1"](https://github.com/kamil1403/otus_selinux/blob/main/screenshots/semanage%20port%2090.png), 🖼️ ["2"](https://github.com/kamil1403/otus_selinux/blob/main/screenshots/audit2why%209002.png), 🖼️ ["3"](https://github.com/kamil1403/otus_selinux/blob/main/screenshots/setsebool.png)
